...
parser.add_argument('--fold_ABC', dest='fold_ABC', help='output directory', type=str, default='./data/train_data/cbox_toplight_pred_to_gt')
parser.add_argument('--name_ABC', dest='name_ABC', help='output file name', type=str, default='toplight_pred_and_irr_gt')
